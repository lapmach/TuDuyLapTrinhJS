            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-4 col-sm-6 col-6">
                        <div className="sanPham" style={{width:60+"%", marginLeft:220+"px"}}>
                            {/* <div className="overlay3"></div>
                                                <div className="iconMuaHang">
                                                    <i className="fa-solid fa-cart-plus"></i>
                                                </div> */}
                            <a href="#">
                                {/* {<img src={data.images} style={{marginLeft: 200+"px"}}></img>} */}
                                {data.images&& data.images.map && data.images.map((image)=> <img src={image}></img>)}
                            </a>
                    ...
                    <div className="col-lg-6 col-md-4 col-sm-6 col-6">
                        <div className="sanPham">
                            {/* <div className="overlay3"></div>
                                ...
                                <h1 style={{marginBottom:20+"px"}}>{data.name}</h1>
                            
                            <a href="#">
                                <h3 style={{color:"#FE6B5E", marginBottom:30+"px"}}>Giá: {data.price} VNĐ</h3>
                            </a>
                            <button style={{marginRight: 10+"px", borderRadius:5+"px", padding:5+"px"}}>Mua Ngay</button>
                            <button style={{marginRight: 10+"px", borderRadius:5+"px", padding:5+"px"}}>Thêm Vào Giỏ Hàng</button>
                            {/* <div className="gia">
                                                <p className="giaCu">4.500.000đ</p>
                                                <p className="giaMoi">4.000.000đ</p>
                                            </div> */}
